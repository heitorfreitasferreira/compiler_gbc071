...
var DefaultDFA *DFA = NewDFA(
	...
	map[int]types.Tuple[types.TokenType, bool]{
		...
		31: {First: types.RELOP, Second: true},
		32: {First: types.RELOP, Second: false},
		33: {First: types.RELOP, Second: false},
		34: {First: types.RELOP, Second: false},
		35: {First: types.TYPE_SEPARATOR, Second: true},
		36: {First: types.ASSIGN, Second: false},
		37: {First: types.ARIOP_POW, Second: false},
		38: {First: types.ARIOP_MULT, Second: true},
		41: {First: types.CONST, Second: true},
		55: {First: types.CONST, Second: false},
		58: {First: types.KW_IF, Second: true},
		65: {First: types.KW_DO, Second: true},
		72: {First: types.KW_TYPE, Second: true},
		76: {First: types.KW_ELSE, Second: true},
		77: {First: types.KW_END, Second: true},
		85: {First: types.KW_TYPE, Second: true},
		87: {First: types.KW_MAIN, Second: true},
		88: {First: types.KW_THEN, Second: true},
		92: {First: types.CONST, Second: true},
		93: {First: types.KW_TYPE, Second: true},
		94: {First: types.KW_BEGIN, Second: true},
		95: {First: types.KW_WHILE, Second: true},
